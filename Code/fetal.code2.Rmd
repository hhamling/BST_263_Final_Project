...
library(readxl)
library(dplyr)
fetal.dat <- read_excel("raw.fetal.data.xlsx")
...
confusionMatrix(predict(rf_default, fetal_test), fetal_test$NSP)
...
Variable importance top 4 most important variables: 1. ALTV 2. MSTV 3. ASTV 4. Mean

```{r}
png(filename = "relative.influence.plot.png", width = 7, height = 5, 
    units = "in", res = 300)
par(mar = c(5, 8, 4, 2))
summary(best_gbm_aggressive_loss_model, las = 1, 
